    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="font-heading text-xl font-extrabold text-foreground">Creator Copilot</span>
        </div>
        ...
        <div className="card-surface p-8">
          ...
          <div className="flex bg-secondary rounded-full p-1 mb-6">
            <button
              ...
              className={`flex-1 py-2 rounded-full text-sm font-medium transition-all ${
                tab === "signin" ? "pill-toggle-active" : "pill-toggle-inactive"
              }`}
            >
              Sign In
            </button>
            <button
              ...
              className={`flex-1 py-2 rounded-full text-sm font-medium transition-all ${
                tab === "signup" ? "pill-toggle-active" : "pill-toggle-inactive"
              }`}
            >
              Create Account
            </button>
          ...
          <p className="text-xs text-muted-foreground text-center mt-5">
            By signing up you agree to our <span className="text-foreground cursor-pointer hover:text-primary transition-colors">Terms</span>.
          </p>
        </div>
      </div>
    </div>
